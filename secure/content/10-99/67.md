...
- [all alone](/english?word=all+alone) *([Fama Intro p.12](https://archive.org/stream/fameconfessionof00vaug#page/n12/mode/2up))*
- [World](/english?word=World) *([Fama Intro p.14](https://archive.org/stream/fameconfessionof00vaug#page/n14/mode/2up))*. The "world" is defined as the scope of our [Understanding](/keys/BINH).
