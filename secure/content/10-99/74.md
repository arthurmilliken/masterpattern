...
- [gross](/english?word=gross) *([Fama Intro p.14](https://archive.org/stream/fameconfessionof00vaug#page/n14/mode/2up))*, meaning "heavy" (like an ox). see [162](162) (gross Errors).
- [same mind](/english?word=same+mind) *([Fama Intro p.14](https://archive.org/stream/fameconfessionof00vaug#page/n14/mode/2up))*.
